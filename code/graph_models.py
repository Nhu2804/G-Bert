...
from build_tree import build_icd9_tree, build_proc_tree  # ĐỔI: build_atc_tree → build_proc_tree
...
class FuseEmbeddings(nn.Module):
    ...
    def __init__(self, config, dx_voc, proc_voc):  # ĐỔI: rx_voc → proc_voc
        ...
        self.ontology_embedding = ConcatEmbeddings(config, dx_voc, proc_voc)  # ĐỔI: rx_voc → proc_voc
